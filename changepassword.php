...
if ( isset( $_POST['changebtn'] ) ) {
    ...
    // Getting submitted user data from database   
        ...
        if(isset($_POST['passwd'])){
            ...
            if ( $user->passwd==null || md5($pass) == $user->passwd) {
...
?>
    <title>Change Password | 101PRESENTS</title>
        ...
        <article>
            <div style="vertical-align: middle;text-align: center;color: white;">
                <form class="box" name="signin" method="post">
                    <h1 class="signup-signin-text">Change Password</h1>
                    <div class="group">
                        <input class="input-text passwd valid" type="password" id="passwd-input" value="" name="passwd" >
